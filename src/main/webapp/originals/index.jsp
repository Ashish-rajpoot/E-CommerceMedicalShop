						...
						<div class="col-md-12">
							<div class="card-columns">
								...
								<div class="card" style="width: 18rem;">
									<img class="card-img-top " style="height: 10rem" src="img/products/<%=c.getpPhoto()%>"
										alt="<%=c.getpPhoto()%>">
									<div class="card-body">
										<h5 class="card-title"><%=c.getpName()%></h5>
										<p class="card-text"><%=Helper.get10Words(c.getpDescription())%></p>
								...
								<div class="card product-card ">
									<!-- <div class="embed-responsive embed-responsive-21by9">embed-responsive-item -->
